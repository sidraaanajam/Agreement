...
<body>
	...
	<!-- About page start -->
	<section id="about-page" class="m-b-30">
		<div class="container">
			<!-- row 1 -->
			<div class="row">
				<div class="col-md-5 col-md-push-1 wow slideInLeft">
					<h3 class="page-content-title"><span>President:</span> Ayesha Bengali</h3>
					<div class="wpb_wrapper">
						<p>Ayesha Bengali has been a consummate volunteer in the Chicagoland area for the past 25 years. She brings passion, experience and dedication to all of her endeavors. She devotes a majority of her time to education and charity-based non-profit organizations to fulfill her drive to help those in need. She is a mother of three and grandmother of four.
						<br><br>
						...
						<br><br>
						Mrs. Bengali currently resides in the western suburbs of Chicago with her husband and youngest son. She can often be found enjoying time with her grandchildren and giving nutritional advice to those who seek her counsel.</p>
					</div>
				</div>
				<div class="col-md-5 col-md-push-1  wow slideInRight">
					<h3 class="page-content-title"><span>Vice President:</span> Shimmi Kidwai</h3>
					<div class="wpb_wrapper">
						<p>For the past thirty years, Shimmi has focused a great deal of her time and effort on supporting social causes and raising funds for charities in the USA, Pakistan and the Washington DC Metropolitan area. She has supported and raised funds for a number of Pakistani and American charities such as Edhi Foundation, Layton Rahmatulla Benevolent Trust (LRBT), SOS, The Kidney Center, Fatimid Foundation, The Imran Khan Foundation / Shaukat Khanum Cancer Hospital, CHAL, JANUM, AMAN Foundation, Children’s Hospital, Lombardi Cancer Center and others.
						<br><br>
			...
			<div class="row">
				<div class="col-md-5 col-md-push-1 wow slideInLeft">
					...
					<div class="wpb_wrapper">
						...
						<br><br>
						He has also served as member of the Board of Governors of Indus Valley School of Art & Architecture, Karachi, National Vocational and Training Commission, GOP, and Intellectual Property Organization, GOP.</p>
					</div>
				</div>
				<div class="col-md-5 col-md-push-1  wow slideInLeft">
					<h3 class="page-content-title"><span>Treasurer:</span> Mehnaz Mulla</h3>
					<div class="wpb_wrapper">
						<p> 
						...
						<br><br>
						– VP Business Development & Customer Relations: Synergies Worldwide<br>
						– Country Manager: American Pacific Enterprises. An American buying-house for textiles<br>
						– Textile Merchandiser : Linmark International<br>
						– Merchandiser: Apparel Buying Services.<br>
						<br><br>
			...
			<div class="row">
				<div class="col-md-5 col-md-push-1 wow slideInRight">
					<h3 class="page-content-title"><span>Secretary:</span> Fatima Khan</h3>
					<div class="wpb_wrapper">
						<p>Fatima Sultan is a Retail Design Planner with Management and Marketing degrees.
						...
						Fatima resides in Pacific Palisades California with her husband.</p>
					</div>
				</div>
				<div class="col-md-5 col-md-push-1  wow slideInRight">
					<h3 class="page-content-title"><span>Assistant Treasurer: </span> Farah Noor Cheema</h3>
					<div class="wpb_wrapper">
						<p>Farah is a graduate from King Edward Medical University in Lahore, Pakistan.
						<br>
			...
			<!-- row 4  -->
			<div class="row">
				<div class="col-md-10 col-md-push-1 wow slideInLeft">
					<h3 class="page-content-title"><span>Director:</span> Sehr Karim-Jaffer</h3>
					<div class="wpb_wrapper">
						<p> 
						...
						<br><br>
						Sehr grew up in the Middle East and recently moved to Karachi with her husband and her one-year-old son, to be closer to family.</p>
					</div>
				</div>
